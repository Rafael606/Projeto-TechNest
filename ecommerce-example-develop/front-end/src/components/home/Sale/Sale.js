...
import img from './gabinete1.png'; // Importa a imagem
import img1 from './Fone.png';
import img2 from './ssdpromo.png';

const Sale = () => {
  return (
    <div className="py-20 flex flex-col md:flex-row items-center justify-between gap-4 lg:gap-10">
      <div className="bg-[#7773739a] w-full md:w-2/3 lg:w-1/2 h-full flex flex-col justify-center items-center text-black">
      ...
      <div className="w-full md:w-2/3 lg:w-1/2 h-auto flex flex-col gap-4 lg:gap-10">
        <div className="h-1/2 w-full">
          <Link to="/shop">
            <Image className="h-full w-full object-cover" imgSrc={img2} />
          </Link>
        </div>
        <div className="h-1/2 w-full">
          <Link to="/shop">
